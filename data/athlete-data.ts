...
const generateDay = (config: any) => {
  ...
  const intra_table: any[] = []
  const epigenetics = { stimuli: [] as string[], stop_rules: [] as string[] }
  const micros = { vitamins: [] as string[], minerals: [] as string[] }
  ...
  return {
    ...
    athlete_profile_notes: [] as string[],
    epigenetics: epigenetics,
    micros: micros,
    amino_profile: { eaa: [] as string[] },
    lipids_fiber: [] as string[],
    microbiota: { drivers: [] as string[], food_matrix: [] as string[], status: "Normal" },
    empathy_indices: [] as string[],
  }
}
